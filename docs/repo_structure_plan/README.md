...
- project-management QML placeholders now bind to presenter-backed workspace metadata through loader-injected `pmCatalog` properties instead of direct global `pmWorkspaceCatalog` access
