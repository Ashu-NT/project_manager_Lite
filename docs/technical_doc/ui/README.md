...
- `ui/modules/maintenance_management/`: early maintenance workspaces for dashboard, assets, sensors, requests, work orders, documents, preventive plans, planner, and reliability
