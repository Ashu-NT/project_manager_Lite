...
- Current business-module state:
  ...
  - `maintenance_management` is implemented as an early available module with persisted foundations plus first dashboard/assets/sensors/requests/work-orders/documents/planner/reliability workspaces
