...
- started: first shell/UI surfaces for `Maintenance Dashboard`, `Assets`, `Requests`, and `Reliability`, backed by the live asset, request, and reliability services
- pending: work-order, document, planner, and technician execution runtimes, plus the later preventive-maintenance template stack
...
- started: workspace registration, module licensing, `Maintenance Dashboard`, `Assets`, `Requests`, and `Reliability` workbench surfaces
