...
- pending: deeper field/mobile confirmation variants and broader reliability exception-review reporting on top of the current execution/runtime foundation
