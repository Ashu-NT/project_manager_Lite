...
Finance Forecast, Inventory Storeroom + Storage Location, Finance Financial Setup.
...
(all but Forecast/Financial Setup), Inventory / Procurement (all but Storeroom/Storage Location),
Auth / Security.
