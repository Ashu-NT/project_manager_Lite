...
PATH_REWRITE_PREFIXES = (
    ...
    ("infra/db/repositories_approval.py", "infra/platform/db/approval/repository.py"),
    ("infra/db/repositories_audit.py", "infra/platform/db/audit/repository.py"),
    ("infra/db/repositories_auth.py", "infra/platform/db/auth/repository.py"),
    ...
    ("infra/db/repositories_timesheet.py", "infra/platform/db/time/repository.py"),
)
