...
class ModuleRuntimeService:
    """Thin runtime-facing seam for module entitlements.

    The catalog remains the source of truth. This wrapper gives the rest of the
    application a stable service contract that can later move behind an
    application or API boundary without changing callers again.
    """
