# core/modules/project_management/services/scheduling/engine.py
...
from core.modules.project_management.services.scheduling.leveling_service import ResourceLevelingMixin
