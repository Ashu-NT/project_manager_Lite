...
from ui.task.assignment_models import AssignmentRow, AssignmentTableModel
...
class TaskAssignmentPanelMixin:
    ...
    def _reload_assignment_panel_for_selected_task(self) -> None:
        ...
        assignments = self._task_service.list_assignments_for_task(task.id)
        ...
        for assignment in assignments:
            ...
            total_alloc += float(assignment.allocation_percent or 0.0)
            total_hours += float(assignment.hours_logged or 0.0)
