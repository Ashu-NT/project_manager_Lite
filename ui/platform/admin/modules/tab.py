...
from core.platform.modules import ModuleCatalogService
...
class ModuleLicensingTab(QWidget):
    ...
    def reload_modules(self) -> None:
        entitlements = self._module_catalog_service.list_entitlements()
        ...
        self.platform_base_badge.setText(
            f"Platform Base: {len(self._module_catalog_service.list_platform_capabilities())} capabilities"
        )
    ...
    def toggle_license(self) -> None:
        ...
        if entitlement.planned:
            ...
            return
        try:
            self._module_catalog_service.set_module_state(
                entitlement.code,
