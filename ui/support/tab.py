...
from infra.update import UpdateCheckResult, check_for_updates
...
class SupportTab(QWidget):
    ...
    def _load_settings(self) -> None:
        ...
        self.manifest_url.setText(
            self._settings_store.load_update_manifest_url(default_url="")
        )
        self._append_result(
    ...
    def _save_update_settings(self) -> None:
        ...
        manifest = self.manifest_url.text().strip()
