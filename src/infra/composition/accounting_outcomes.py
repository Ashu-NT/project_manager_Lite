...
def build_external_accounting_ingress(*, engine, authenticator, clock=None, transactional_dispatcher=None, post_commit_bus=None):
    ...
    return AccountingOutcomeIngress(
        ...
        consumer=SqlAlchemyAccountingOutcomeConsumer(
            session_factory=sessions, clock=clock or SystemClock(),
            transactional_dispatcher=transactional_dispatcher or InProcessTransactionalEventDispatcher(),
