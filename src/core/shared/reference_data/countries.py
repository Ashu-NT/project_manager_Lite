...
_ISO_3166_1: dict[str, str] = {
    ...
    "SX": "Sint Maarten", "SY": "Syrian Arab Republic", "SZ": "Eswatini",
    ...
    "TR": "Türkiye", "TT": "Trinidad and Tobago", "TV": "Tuvalu",
...
ISO_3166_1_COUNTRIES = MappingProxyType(_ISO_3166_1)

COUNTRY_OPTIONS: tuple[tuple[str, str], ...] = tuple(
    sorted(_ISO_3166_1.items(), key=lambda pair: pair[1])
)
...
def country_name_for_code(code: str) -> str:
    ...
    return ISO_3166_1_COUNTRIES.get(normalized, "")
