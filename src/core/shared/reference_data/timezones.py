...
_TIMEZONE_NAMES: tuple[str, ...] = (
    ...
    "Asia/Dushanbe", "Asia/Famagusta", "Asia/Gaza", "Asia/Hanoi", "Asia/Harbin", "Asia/Hebron",
    ...
    "Brazil/DeNoronha", "Brazil/East", "Brazil/West", "Canada/Atlantic", "Canada/Central",
    ...
    "Indian/Mayotte", "Indian/Reunion", "Mexico/BajaNorte", "Mexico/BajaSur", "Mexico/General",
...
IANA_TIMEZONES = frozenset(_TIMEZONE_NAMES)

TIMEZONE_OPTIONS: tuple[tuple[str, str], ...] = tuple(
    (name, name) for name in sorted(_TIMEZONE_NAMES)
)
