...
DEFAULT_PERMISSIONS: dict[str, str] = {
    ...
    "finance.accounting_handoff.request": "Request delivery of approved commercial evidence",
    "finance.accounting_status.read": "View external Accounting handoff status",
    "integration.accounting.configure": "Configure organization Accounting integration",
