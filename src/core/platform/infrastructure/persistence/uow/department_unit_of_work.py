...
from src.core.platform.contract.uow.department_unit_of_work import DepartmentUnitOfWork
...
class SqlAlchemyDepartmentUnitOfWork(SqlAlchemyUnitOfWorkBase, DepartmentUnitOfWork):
    def __init__(
        self,
        *,
        session: Session,
        ...
        for repo in (self.departments, self.sites, self.employees):
...
class SqlAlchemyDepartmentUnitOfWorkFactory(SqlAlchemyUnitOfWorkFactoryBase):
    def __init__(
        self,
        *,
    ...
    def create(self, *, context: DomainEventContext) -> SqlAlchemyDepartmentUnitOfWork:
        return SqlAlchemyDepartmentUnitOfWork(
...
__all__ = ["SqlAlchemyDepartmentUnitOfWork", "SqlAlchemyDepartmentUnitOfWorkFactory"]
