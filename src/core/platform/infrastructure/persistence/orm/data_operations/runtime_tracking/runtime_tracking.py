...
class RuntimeExecutionORM(Base):
    ...
    authorization_context_id: Mapped[str | None] = mapped_column(String, nullable=True)
    ...
    output_media_type: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    cancellation_requested_by_user_id: Mapped[str | None] = mapped_column(String, nullable=True)
    cancellation_requested_by_username: Mapped[str | None] = mapped_column(String(128), nullable=True)
    retry_of_execution_id: Mapped[str | None] = mapped_column(String, nullable=True)
