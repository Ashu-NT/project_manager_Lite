...
from src.core.platform.infrastructure.persistence.documents.mapper import (
    document_from_orm,
...
from src.core.platform.infrastructure.persistence.orm.models import DocumentLinkORM, DocumentORM, DocumentStructureORM
