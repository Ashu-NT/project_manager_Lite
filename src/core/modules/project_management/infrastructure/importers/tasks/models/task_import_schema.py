...
TASK_IMPORT_SCHEMA: tuple[ImportFieldSpec, ...] = (
    ...
    ImportFieldSpec("task_code", "Task Code"),
    ImportFieldSpec("wbs_code", "WBS Code"),
    ImportFieldSpec("parent_wbs_code", "Parent WBS Code"),
    ImportFieldSpec("sort_order", "Sibling Order"),
