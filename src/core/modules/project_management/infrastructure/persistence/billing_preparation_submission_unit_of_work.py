...
class SqlAlchemyBillingPreparationSubmissionUnitOfWork(
    SqlAlchemyUnitOfWorkBase, BillingPreparationSubmissionUnitOfWork
):
    def __init__(
        self,
        *,
        ...
        self.billing._tenant_context_service = tenant_context_service
...
class SqlAlchemyBillingPreparationSubmissionUnitOfWorkFactory(SqlAlchemyUnitOfWorkFactoryBase):
    ...
    def create(self, *, context: DomainEventContext) -> SqlAlchemyBillingPreparationSubmissionUnitOfWork:
        return SqlAlchemyBillingPreparationSubmissionUnitOfWork(
