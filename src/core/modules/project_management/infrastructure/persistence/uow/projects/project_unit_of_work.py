...
class SqlAlchemyProjectUnitOfWork(SqlAlchemyUnitOfWorkBase, ProjectUnitOfWork):
    def __init__(
        self,
        *,
        session: Session,
        ...
        self.financial_profiles = SqlAlchemyProjectFinancialProfileRepository(session)
        for repo in (self.projects, self.financial_profiles):
...
class SqlAlchemyProjectUnitOfWorkFactory(SqlAlchemyUnitOfWorkFactoryBase):
    def __init__(
        self,
        *,
    ...
    def create(self, *, context: DomainEventContext) -> SqlAlchemyProjectUnitOfWork:
...
__all__ = ["SqlAlchemyProjectUnitOfWork", "SqlAlchemyProjectUnitOfWorkFactory"]
