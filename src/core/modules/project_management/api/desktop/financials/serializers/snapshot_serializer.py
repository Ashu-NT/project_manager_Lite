...
def serialize_overview(project_id: str, facts) -> FinancialOverviewDto:
    ...
    return FinancialOverviewDto(
        ...
        budget_label=(
            format_money(facts.approved_budget, currency)
            if has_approved_budget
            else "Not approved"
        ),
        ...
        available_label=(
            format_money(facts.available_after_commitment, currency)
            if has_approved_budget
            else "Not available"
        ),
        ...
        estimate_at_completion_label=optional_label(
            facts.estimate_at_completion,
            "Not available",
        ),
        variance_at_completion=optional_amount(facts.variance_at_completion),
        variance_at_completion_label=optional_label(
            facts.variance_at_completion,
            "Not available",
        ),
