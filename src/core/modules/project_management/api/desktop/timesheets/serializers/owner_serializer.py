...
def serialize_owner_period(
    fact: OwnerTimesheetPeriodFact,
) -> OwnerTimesheetPeriodDesktopDto:
    return OwnerTimesheetPeriodDesktopDto(
...
def serialize_owner_entry(
    fact: OwnerTimesheetEntryFact,
) -> OwnerTimesheetEntryDesktopDto:
    return OwnerTimesheetEntryDesktopDto(
...
__all__ = ["serialize_owner_entry", "serialize_owner_period"]
