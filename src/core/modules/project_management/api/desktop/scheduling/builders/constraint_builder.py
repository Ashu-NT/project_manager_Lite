...
def build_constraint_violations(
    ...
    *,
    ...
    if not project_id or scheduling_engine is None or task_service is None or constraint_validator is None:
        return ()
    try:
        ...
        result = constraint_validator.validate(tasks_by_id, schedule)
