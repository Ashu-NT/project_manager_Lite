...
class PortfolioExecutiveDesktopSnapshot:
    ...
    independent of any Heatmap/Dependencies page size. top_at_risk_projects is
    the same bounded/top_n ranking as PortfolioService.list_top_at_risk_projects(),
    derived here from the same single full-scope heatmap computation rather than
    a second scan."""
