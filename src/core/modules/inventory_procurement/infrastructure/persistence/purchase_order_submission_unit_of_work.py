...
class SqlAlchemyPurchaseOrderSubmissionUnitOfWork(
    SqlAlchemyUnitOfWorkBase, PurchaseOrderSubmissionUnitOfWork
):
    def __init__(
        self,
        *,
...
class SqlAlchemyPurchaseOrderSubmissionUnitOfWorkFactory(SqlAlchemyUnitOfWorkFactoryBase):
    ...
    def create(self, *, context: DomainEventContext) -> SqlAlchemyPurchaseOrderSubmissionUnitOfWork:
        return SqlAlchemyPurchaseOrderSubmissionUnitOfWork(
...
__all__ = [
    "SqlAlchemyPurchaseOrderSubmissionUnitOfWork",
