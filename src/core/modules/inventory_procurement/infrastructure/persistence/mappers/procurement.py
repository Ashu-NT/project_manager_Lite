...
def purchase_requisition_to_orm(requisition: PurchaseRequisition) -> PurchaseRequisitionORM:
    return PurchaseRequisitionORM(
        ...
        source_module=requisition.source_module or None,
        source_entity_type=requisition.source_entity_type or None,
        source_code_snapshot=requisition.source_code_snapshot or None,
        source_title_snapshot=requisition.source_title_snapshot or None,
        source_status_snapshot=requisition.source_status_snapshot or None,
