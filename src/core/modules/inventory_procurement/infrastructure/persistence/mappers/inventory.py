...
def stock_transaction_from_orm(obj: StockTransactionORM) -> StockTransaction:
    return StockTransaction(
        ...
        performed_by_username=obj.performed_by_username,
        resulting_on_hand_qty=obj.resulting_on_hand_qty,
        resulting_available_qty=obj.resulting_available_qty,
        notes=obj.notes,
...
def stock_reservation_to_orm(reservation: StockReservation) -> StockReservationORM:
    return StockReservationORM(
        ...
        source_module=reservation.source_module or None,
        source_entity_type=reservation.source_entity_type or None,
        source_code_snapshot=reservation.source_code_snapshot or None,
        source_title_snapshot=reservation.source_title_snapshot or None,
        source_status_snapshot=reservation.source_status_snapshot or None,
...
def stock_reservation_from_orm(obj: StockReservationORM) -> StockReservation:
    return StockReservation(
        ...
        source_module=getattr(obj, "source_module", None) or "",
        source_entity_type=getattr(obj, "source_entity_type", None) or "",
        source_code_snapshot=getattr(obj, "source_code_snapshot", None) or "",
        source_title_snapshot=getattr(obj, "source_title_snapshot", None) or "",
        source_status_snapshot=getattr(obj, "source_status_snapshot", None) or "",
