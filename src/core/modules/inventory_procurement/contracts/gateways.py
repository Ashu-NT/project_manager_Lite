...
from src.core.modules.inventory_procurement.domain.inventory import (
    StockReservation,
    StockTransaction,
)
from src.core.modules.inventory_procurement.domain.procurement import (
    PurchaseRequisition,
...
class MaintenanceMaterialAvailability:
    ...
    can_issue_from_stock: bool = False
    can_direct_procure: bool = False
