...
def test_maintenance_root_repositories_hide_cross_organization_rows_list(services) -> None:
    ...
    # list_for_organization() returns current-org rows
    ...
    # list_for_organization() returns empty list for other org
    ...
    # current-org IDs present; other-org IDs absent from current-org lists
