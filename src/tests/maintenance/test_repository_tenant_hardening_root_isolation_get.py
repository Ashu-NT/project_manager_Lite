...
def test_maintenance_root_repositories_hide_cross_organization_rows_get(services) -> None:
    ...
    # get() returns None for other-org IDs
    ...
    # get_by_code() returns None when org_id is from the other org
