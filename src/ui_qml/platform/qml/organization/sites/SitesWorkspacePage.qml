...
AppLayouts.WorkspaceFrame {
    ...
    function handleDetailAction(actionId) {
        ...
        if (actionId === "toggle_active" && root.workspaceController) { root.workspaceController.toggleSiteActive(id); return }
    }
        ...
        RowLayout {
            ...
            AppWidgets.InspectorPanel {
                ...
                onSecondaryActionRequested: {
                    if (root.workspaceController) root.workspaceController.toggleSiteActive(root.selectedRowId)
                }
            }
        }
