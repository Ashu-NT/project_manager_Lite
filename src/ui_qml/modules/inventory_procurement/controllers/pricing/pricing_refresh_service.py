...
def refresh_site_options(ctrl) -> None:
    site_options, storeroom_options = ctrl._pricing_workspace_presenter.build_site_reference_options()
...
def refresh_party_options(ctrl) -> None:
    supplier_options = ctrl._pricing_workspace_presenter.build_party_reference_options()
