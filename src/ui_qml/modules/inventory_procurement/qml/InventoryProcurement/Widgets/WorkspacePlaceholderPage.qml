...
AppLayouts.WorkspaceFrame {
    ...
    property string architectureSummary: "This workspace now binds through the inventory QML catalog and is ready for workflow-by-workflow migration."
    readonly property var workspaceModel: root.inventoryCatalog
        ? root.inventoryCatalog.workspace(root.routeId)
        : ({
