...
class ProjectPortfolioWorkspacePresenter:
    ...
    def build_workspace_state(
        ...
        *,
        ...
        return PortfolioWorkspaceViewModel(
            ...
            capacity_pool=self._build_capacity_pool_view_model(),
    ...
    def _build_capacity_pool_view_model(self) -> PortfolioCollectionViewModel:
        from src.ui_qml.modules.project_management.view_models.portfolio import PortfolioRecordViewModel
        dtos = self._desktop_api.build_capacity_pool()
        items = tuple(
            PortfolioRecordViewModel(
                id=dto.resource_id,
                ...
                supporting_text=", ".join(dto.demand_entries) if dto.demand_entries else "No active assignments",
