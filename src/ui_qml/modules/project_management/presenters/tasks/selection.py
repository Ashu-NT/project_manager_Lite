...
def resolve_task_id(selected_task_id: str | None, filtered_tasks) -> str:
...
def resolve_assignment_id(selected_assignment_id: str | None, assignments) -> str:
...
def resolve_time_entry_id(selected_time_entry_id: str | None, entries) -> str:
