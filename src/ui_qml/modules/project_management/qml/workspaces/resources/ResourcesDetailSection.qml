...
Item {
    ...
    Column {
        ...
        AppWidgets.SectionHeading { label: "Calendar" }
        ...
        AppWidgets.SectionHeading { label: "Skills" }
        ...
        AppWidgets.SectionHeading { label: "Certifications" }
        ...
        AppWidgets.SectionHeading { label: "Cost Rates" }
