...
Flow {
    ...
    property string architectureStatus: "Desktop API boundary ready"
    property string architectureSummary: "Typed QML bindings are ready for the next maintenance workflow migration."
