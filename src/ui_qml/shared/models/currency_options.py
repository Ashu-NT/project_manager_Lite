...
# ISO_4217_MINOR_UNITS. Static reference data only -- purely a display label
# for the currency dropdowns; a code missing here still shows (falls back to
# the bare code) rather than being hidden.
_CURRENCY_NAMES: dict[str, str] = {
    ...
    "BBD": "Barbados Dollar", "BDT": "Taka", "BHD": "Bahraini Dinar",
    "BIF": "Burundi Franc", "BMD": "Bermudian Dollar", "BND": "Brunei Dollar",
    "BOB": "Boliviano", "BOV": "Mvdol", "BRL": "Brazilian Real",
    "BSD": "Bahamian Dollar", "BTN": "Ngultrum", "BWP": "Pula",
    "BYN": "Belarusian Ruble", "BZD": "Belize Dollar", "CAD": "Canadian Dollar",
    "CDF": "Congolese Franc", "CHE": "WIR Euro", "CHF": "Swiss Franc",
    "CHW": "WIR Franc", "CLF": "Unidad de Fomento", "CLP": "Chilean Peso",
    "CNY": "Yuan Renminbi", "COP": "Colombian Peso", "COU": "Unidad de Valor Real",
    ...
    "GNF": "Guinean Franc", "GTQ": "Quetzal", "GYD": "Guyana Dollar",
    ...
    "SHP": "Saint Helena Pound", "SLE": "Leone", "SOS": "Somali Shilling",
    ...
    "VUV": "Vatu", "WST": "Tala", "XAD": "Arab Accounting Dinar",
    "XAF": "CFA Franc BEAC", "XAG": "Silver", "XAU": "Gold",
    ...
    "XPD": "Palladium", "XPF": "CFP Franc", "XPT": "Platinum",
    "XSU": "Sucre", "XTS": "Codes reserved for testing purposes",
    "XUA": "ADB Unit of Account",
    "XXX": "No currency involved", "YER": "Yemeni Rial", "ZAR": "Rand",
...
CURRENCY_OPTIONS: list[dict[str, str]] = [
    {"value": code, "label": _currency_label(code)}
    for code in sorted(
