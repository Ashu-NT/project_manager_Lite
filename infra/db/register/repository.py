...
from core.interfaces import RegisterEntryRepository
from core.models import RegisterEntry, RegisterEntrySeverity, RegisterEntryStatus, RegisterEntryType
from infra.db.models import RegisterEntryORM
